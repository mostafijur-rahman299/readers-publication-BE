...
from .views import CarouselListViewSet, get_general_data, TestimonialListAPIView, get_state_list, get_city_list, get_thana_list, get_union_list
...
urlpatterns = [
    ...
    path('api/v1/union-list/', get_union_list, name='union-list'),
]